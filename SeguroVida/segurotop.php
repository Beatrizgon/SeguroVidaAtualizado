...
<head>
  ...
  <link rel="stylesheet" href="segurotop.css">
      ...
      <div class="about-content">
        <div class="about-content">
          ...
          <div class="column right">
            <p style="text-indent: 2em;"> É um excelente Seguro para jovens que desejam uma proteção mais completa, com benefícios adicionais que oferecem mais segurança e tranquilidade em situações imprevistas. É ideal para quem busca um plano mais robusto, sem comprometer o orçamento, garantindo um suporte financeiro mais sólido em momentos difíceis.</p>
            <p style="text-indent: 2em;"><br>Mensalidade: A partir de R$ 33,90/mês.<br>Cobertura e Benefícios<br>- Cobertura em caso de morte natural ou acidental: R$ 70.000;<br>- Cobertura para invalidez por acidente: R$ 30.000;<br>-Assistência funeral ampliada, incluindo transporte;<br>- Adiantamento de 20% do valor segurado em caso de diagnóstico de doenças terminais;<br> <br>Indicação <br>
              Este plano é especialmente recomendado para jovens que buscam um seguro de vida básico, oferecendo proteção essencial em caso de imprevistos, sem comprometer o orçamento. Ideal para quem deseja garantir segurança e tranquilidade para si e seus familiares a um custo acessível.</p>
          </div>
        </div>
      </div>
  </section>
