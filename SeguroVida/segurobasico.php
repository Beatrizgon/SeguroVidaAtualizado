...
<head>
  ...
  <link rel="stylesheet" href="segurobasico.css">
...
<body>
  ...
  <section class="about" id="about">
    <div class="max-width">
      <h2 class="title">Seguro Básico</h2>
      <div class="about-content">
        <div class="about-content">
          ...
          <div class="column right">
            <p style="text-indent: 2em;">É um Seguro ideal para quem busca uma proteção acessível e confiável, oferecendo segurança em momentos difíceis sem pesar no bolso. Com benefícios simples, mas eficazes, ele garante que você e seus familiares terão o apoio necessário quando mais precisarem, proporcionando tranquilidade e suporte em situações imprevistas.</p>
            <p style="text-indent: 2em;"><br>Mensalidade: A partir de R$ 24,90/mês<br>- Cobertura e Benefícios; <br>- Cobertura em caso de morte natural ou acidental: R$ 50.000; <br>- Assistência funeral básica; <br>- Consultoria financeira para familiares;
            <p>Indicação<br>
