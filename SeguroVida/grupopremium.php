...
<head>
  ...
  <link rel="stylesheet" href="grupopremium.css">
...
<body>
  ...
  <section class="about" id="about">
    <div class="max-width">
      <h2 class="title">Grupo Premium</h2>
      <div class="about-content">
        <div class="about-content">
          ...
          <div class="column right">
            <p style="text-indent: 2em;">Oferece uma cobertura financeira significativa e benefícios adicionais para até 5 membros da família, com uma assistência completa em situações delicadas. Ideal para grupos que buscam proteção em diferentes momentos da vida, este plano garante um suporte amplo, incluindo consultoria financeira e psicológica, e cobertura funeral que se estende nacional e internacionalmente.</p>
            <p style="text-indent: 2em;"><br>Mensalidade: A partir de R$ 54,90/mês<br>- Cobertura e Benefícios; <br>- Cobertura individual para até 5 membros: R$ 60.000 por pessoa; <br>- Indenização dupla em caso de acidentes durante viagens em grupo; <br>- Consultoria financeira e psicológica para todos os membros; <br>- Assistência funeral completa, incluindo transporte nacional e internacional.
            <p>Indicação<br>
              Esse plano é indicado para aqueles que buscam uma solução de alto nível, com uma cobertura mais abrangente e apoio contínuo, garantindo tranquilidade e suporte nos momentos mais desafiadores.</p>
